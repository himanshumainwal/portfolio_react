      ...
      <div className='max-w-7xl mx-auto'>
        <div className='flex flex-col md:flex-row items-center lg:h-[90vh] justify-between' >
          <div className='md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-10'>
            ...
            <p className='md:text-2xl text-xl mb-4'><span className='text-red-600 font-bold'>Full Stack</span> Developer</p>
            <p className='mb-4'>I'm a passionate Full Stack Developer skilled in React.js, JavaScript, Node.js, and modern web technologies. I specialize in building scalable, high-performance applications with clean architecture and seamless user experiences that solve real-world problems.</p>
            <button className='hover:bg-red-700 hover:text-white px-3 py-2 w-max bg-transparent border border-red-700 text-red-700 transition duration-700 rounded-md'><a href={my_Resume} download="Himanshu_Resume.pdf" target='_blank'>Download CV</a></button>
          </div>
