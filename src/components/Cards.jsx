        ...
        <div key={index} className='border border-red-200 shadow-lg shadow-red-300 rounded-lg w-[350px] lg:w-[400px] text-white transform transition duration-500 hover:scale-105'>
            ...
            <div className='p-4'>
                ...
                <div className='flex gap-3 mt-4'>
                    <button className='hover:bg-red-700 bg-transparent border border-red-700 text-red-700 transition duration-700 hover:text-white px-3 py-2 rounded-md'><a href={item.live} target='_blank'>Live Preview</a></button>
