...
const Navbar = () => {
  ...
  return (
    <header className='sticky opacity-75 top-0 z-50 w-full bg-gradient-to-r from-[#b91c1c] to-[#7f1d1d] hover:from-[#7f1d1d] hover:to-[#b91c1c] px-4 lg:px-0 text-white'>
      ...
      {mobileMenuOpen && (
        <div className='md:hidden'>
          <div className='space-y-1 bg-gradient-to-r from-[#b91c1c] to-[#7f1d1d] px-2 pb-3 pt-2 h-screen absolute right-0 w-2/3 rounded-bl-2xl'>
            <Link to="/" className='block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-gray-50 hover:text-red-700'>Home</Link>
            <Link to="/about" className='block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-gray-50 hover:text-red-700'>About</Link>
            <Link to="/projects" className='block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-gray-50 hover:text-red-700'>Project</Link>
            <Link to="/contact" className='block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-gray-50 hover:text-red-700'>Contact</Link>
          </div>
        </div>
      )}
    </header>
